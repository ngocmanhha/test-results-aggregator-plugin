...
Supports 'free style project' and 'pipeline' after 1.1.8.
...
Example 2 with buildNumber:
    ...
    testResultsAggregator columns: 'Job, Build, Status, Percentage, Total, Pass, Fail',
                          ...
                          subject: 'Test Results'
                        	 jobs: [
                                [jobName: 'My CI Job1', jobFriendlyName: 'Job 1', groupName: 'TeamA', buildNumber: 1],
                                [jobName: 'My CI Job1', jobFriendlyName: 'Job 1', groupName: 'TeamA', buildNumber: 2],
                                [jobName: 'My CI Job3', groupName: 'TeamB', buildNumber: 1], // jobFriendlyName is optional
                                [jobName: 'My CI Job3', groupName: 'TeamB', buildNumber: 2], // jobFriendlyName is optional
                                [jobName: 'My CI Job4', buildNumber: 1], // groupName is optional
                                [jobName: 'My CI Job4', buildNumber: 2] // groupName is optional
                            ]
