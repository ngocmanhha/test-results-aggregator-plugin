...
public class TestResultsAggregator extends Notifier implements SimpleBuildStep {
	...
	public String getColumns() {
		// All are : Health, Job, Build, Status, Percentage, Total, Pass, Fail, Skip, Commits, LastRun, Duration, Packages, Files, Classes, Methods, Lines, Conditions, Sonar
		// Default if not set for pipeline are :
